          ...
          <View style={styles.headerConatiner}>
            <View>
              ...
              <View style={styles.btn}>
                <TouchableOpacity onPress={() => this.openModelScreen(0)}>
                  <Text>SIGN IN</Text>
                </TouchableOpacity>
                <View style={styles.verticalLine} />
                <TouchableOpacity onPress={() => this.openModelScreen(1)}>
                  <Text>JOIN</Text>
                </TouchableOpacity>
              </View>
            </View>
          ...
          <Modal
            ...
            <View style={styles.modelheaderContainer}>
              <TouchableOpacity
                ...
                onPress={() => this.openModelScreen(0)}>
                <Text style={styles.text}>Sign In</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={this.state.screen === 1 ? styles.border : null}
                onPress={() => this.openModelScreen(1)}>
                <Text style={styles.text}>Join</Text>
              </TouchableOpacity>
            </View>
            {this.state.screen === 0
              ? this.props.navigation.navigate('SignIn')
              : this.props.navigation.navigate('JoinIn')}
          </Modal>
        </View>
      </>
    );
